...
class Admindata extends CI_Controller
{
    ...
    public function users()
    {
        ...
        $this->db->select('users.id, users.name, users.email, users.image, users.password, users.role_id, user_role.role AS nama_role, users.id_sales, sales.nama_sales AS nama_sales, users.is_active, users.date_created');
        $this->db->from('users');
